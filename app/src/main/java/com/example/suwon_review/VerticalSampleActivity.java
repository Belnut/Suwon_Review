...
public class VerticalSampleActivity extends AppCompatActivity {
    ...
    private class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            switch (position % 5) {
                case 0 : holder.iv.setImageResource(R.drawable.easydon); break;
                case 1 : holder.iv.setImageResource(R.drawable.fox); break;
                case 2 : holder.iv.setImageResource(R.drawable.oakryu); break;
                case 3 : holder.iv.setImageResource(R.drawable.easydon); break;
                case 4 : holder.iv.setImageResource(R.drawable.fox); break;
            }
        }
